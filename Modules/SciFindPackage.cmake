...
function(SciGetInstSubdirs pkgnamelc instdirsvar)
  ...
  if (ENABLE_PARALLEL)
    ...
    if (USE_PYC_LIBS)
      if (USE_SHARED_LIBS)
        set(instdirs ${pkgnamelc}-pycsh ${pkgnamelc}-pycmd ${pkgnamelc}-pycst ${pkgnamelc}-sersh ${pkgnamelc}-sermd ${pkgnamelc})
      else ()
        set(instdirs ${pkgnamelc}-pycmd ${pkgnamelc}-pycst ${pkgnamelc}-pycsh ${pkgnamelc}-sermd ${pkgnamelc} ${pkgnamelc}-sersh)
      endif ()
