...
function(SciGetInstSubdirs pkgnamelc instdirsvar)
  ...
  if (ENABLE_PARALLEL)
    ...
    if (USE_PYC_LIBS)
      set(instdirs ${pkgnamelc}-pycsh ${pkgnamelc}-pycst ${pkgnamelc}-pycmd ${pkgnamelc}-sersh ${pkgnamelc}-sermd ${pkgnamelc})
      if (FALSE)
      if (WIN32)
        set(instdirs ${instdirs} ${pkgnamelc}-pycmd ${pkgnamelc}-sermd)
      else ()
        set(instdirs ${instdirs} ${pkgnamelc})
      endif ()
      endif ()
